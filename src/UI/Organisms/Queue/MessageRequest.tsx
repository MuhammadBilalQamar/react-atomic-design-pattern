...
export default function PricingMessageModal({ handleClose, isOpen = false }: Props) {
    return <Modal handleClose={handleClose} open={isOpen} width={"sm"}>
        <div className='flex justify-center bg-red-700 w-full h-8/12 p-4'>
            <Label classes={{root:"text-white uppercase"}} value='Pricing Message'/>
        </div>
        <div className='px-2 py-1'>
            <Label value='Pricing Message'/>
